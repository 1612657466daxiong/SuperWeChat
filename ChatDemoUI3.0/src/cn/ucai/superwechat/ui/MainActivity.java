...
//                }
    ...
    public void onPageSelected(int position) {
        mtbhost.setChecked(position);
        mfvpager.setCurrentItem(position);
    ...
    public void updateUnreadLabel() {
        ...
        mtbhost.setUnreadCount(0,count);
    ...
    public void updateUnreadAddressLable() {
        runOnUiThread(new Runnable() {
            public void run() {
				...
				if (count > 0) {
                    mtbhost.setHasNew(1,true);
				} else {
                    mtbhost.setHasNew(1,false);
				}
            }
        });
    ...
    protected void onNewIntent(Intent intent) {
        ...
        boolean flag = getIntent().getBooleanExtra(I.ACTION_BACKMSG_CANVERS, false);
        L.e(TAG,"onResume "+flag);
        if (flag){
            mtbhost.setChecked(0);
        }
    }
